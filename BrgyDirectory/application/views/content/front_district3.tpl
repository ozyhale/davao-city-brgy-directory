...
<div id="content">
    ...
    {if !empty($district3)}
        ...
        <table style=" border-color: black;"class="text-info table table-bordered table-hover data-table-no-search">
            ...
            <thead>
                <tr>
                    <th style=" border-color: black;" colspan="3">DISTRICT 3</th>
                </tr>
                <tr>
        ...
        <div id="content">
            <h5 style="color: rgb(58,135,173); font-family: inherit; font-size: 35px;" class="title1">District 3</h5>
            <div class="scroller dist1">
                <div class="inside">

                    {if count($district3) <= 2 }
                ...
                {else}
                    <div class="span10">
                        <h2 class="text-info">District 3</h2>
